...
criaCartao(
    'Minecraft',
    'Como é o nome do mob preto? Ele só atacara o jogador, caso olhe diretamente nos olhos dele',
    'Enderman, se você disse outra coisa, procure ajuda!'
)

criaCartao(
    'Anime',
    'Qual é o protagosnista do anime "Naruto"?',
    'Naruto.'
)
